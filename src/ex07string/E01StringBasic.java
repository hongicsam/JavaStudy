...
public class E01StringBasic {
	...
	public static void main(String[] args) {
		...
		/*
		equals()메서드 : Object클래스로부터 상속받은 메서드로 실제 저장된 문자열을 비교하도록 정의되어있다.
		...
		/*
		String클래스의 인스턴스 생성 방법 2 : 
			더블쿼테이션을 사용한다.
			이 경우 내용이 동일하다면 같은 주소를 사용한다.
			즉 새로운 메모리를 할당하지 않는다.
			따라서 String객체는 주로 방법 2를 통해 사용하는것이 좋다.
		 */
		String str3 = "자바개발자";
		String str4 = "자바개발자";
