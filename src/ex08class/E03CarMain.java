...
class Car {
	...
	/*
	초기화메서드1 : 매개변수가 없는 형태로 항상 고정된 값으로만 인스턴스를 초기화할수있다.
...
public class E03CarMain {
	...
	public static void main(String[] args) {
		...
		/*
		자동차2 객체 생성 : 초기화 메서드를 호출하는 대신 멤버변수에 직접 접근하여 인스턴스를 초기화한다.
			이 경우 인스턴스를 생성할때마다 동일한 코드를 작성해야 하므로 중복이 많아지게되어 비효율적이다.
