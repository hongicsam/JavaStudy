...
//	}
	...
	public boolean equals(Object obj) {
		/*
		매개변수로 전달된 인스턴스를 Object로 받으면 업캐스팅이되므로 다운캐스팅 이후에 비교를 해야한다.
		이때 전달된 인스턴스가 MyClass형이 아니라면 비교의 대상이 될수 없으므로
		...
		if(obj instanceof MyClass) {
			...
			/*
			매개변수로 전달된 인스턴스가 MyClass 타입이 아니라면 비교의 대상이 될수없으므로 false를 반환한다.
			 */
