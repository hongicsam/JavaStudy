...
/*
Wrapper : 
	기본자료형의 데이터를 인스턴스화할때 사용하는 클래스로 Boxing 혹은 Unboxing을 통해 기본자료형의 데이터를 인스턴스화한다.
...
public class E01WrapperClass1 {
	...
	public static void main(String[] args) {
		...
		/*
		JDK1.4 이전의 코딩형태
		기본자료형을 박싱 처리한 인스턴스에 대해서 산술연산을 진행할때 언박싱을 위해 intValue()와 같은 메서드를 호출해야한다.
		 */
		// 현재는 이와같은 생성자는 Depercated(디플리케이트)되었다.
