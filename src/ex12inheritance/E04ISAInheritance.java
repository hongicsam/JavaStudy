...
//	public Computer(){}
	...
	/*
	private 접근지정자로 선언된 멤버메서드는 외부 클래스 혹은 상속받은 클래스에서 접근이 불가능하므로,
	...
	/*
	private으로 선언된 멤버메서드를 외부에서 호출할 수 있게 public으로 지정하여 선언한 메서드로 '캡슐화' 되어있다.
	 */
...
class NotebookComputer extends Computer {
	...
	public void movigCal() {
		...
		/*
		아래 2개의 메서드는 private으로 선언되었으므로 상속을 받은 자식클래스에서도 접근할 수 없어 에러가 발생된다.
...
/*
테블릿 노트북 : 컴퓨터의 기본연산기능과, 휴대이용 그리고 전용 펜으로 드로잉 할 수 있는 기능까지 추가된 컴퓨터를 추상화한다.
 */
class TabletNotebook extends NotebookComputer {
	...
	public void write(String penInfo) {
		...
		A.compareTo(B) : 
			...
			-1 혹은 1이 반환되면 서로 다른문자열로 판단하는 String 클래스에 정의된 메서드
		 */
		...
		상속받은 자식클래스에서는 이와같이 부모의 멤버메서드를 호출하여 자신의 기능처럼 사용할 수 있다.
...
public class E04ISAInheritance {
	...
	public static void main(String[] args) {
		...
		System.out.println("==ISE-9876 펜으로 테블릿사용==");
		tablet.write("ISE-9876"); // 사용불가
	}
