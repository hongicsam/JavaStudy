...
//		System.out.println(name + "이(가) 공부한다.");
	...
	/*
	오버라이딩 아님 : 부모클래스에서 private멤버로 선언하였으므로 자식쪽에서는 보이지 않아 오버라이딩의 대상이 될수없다.
	...
	- 부모에서 defalut로 선언하면 자식에서는 default 혹은 그보다 넓은 public으로 선언하면 오버라이딩이 가능하다.
	 */
	@Override
	public String sleep() {
	...
	클래스 외부(메서드 영역)에 미리 로드되므로 오버라이딩 되지않고, 호출할때 각 클래스명을 통해 사용해야한다.
	 */
