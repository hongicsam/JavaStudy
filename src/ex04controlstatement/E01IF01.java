...
//		}
		...
		/*
		조건 검사루 실행할 문장이 1개인 경우에는 중괄호를 생략할수 있다.
		단, 실행문이 2개이상이라면 한 문장만 if문에 포함되므로 반드시 중괄호를 기술해야한다.
		 */
		if(num%2==0)
			System.out.println("\n" + num + "은 짝수이다.");
		if(num%2!=0) {
		...
		int asciCode = System.in.read();
		System.out.println("입력한 문자는:" + asciCode);
