...
public class E04DoWhile {
	...
	public static void main(String[] args) throws IOException {
		...
		/*
		시나리오] E03 예제의 1~10까지의 더하는 수열문제를 do~while문으로 변경하여 구현하시오.
		 */
		// 누적합과 반복을 위한 변수
		int sum = 0;
		int i = 1;
		...
		*****
		 ...
		 */
		// 사용자로부터 입력을 받기위해 Scanner인스턴스 생성
		...
		do {
			...
			switch문은 조건식은 사용할 수 없고 산술식만 사용할 수 있으므로 99점 혹은 91점을 10으로 나눈 몫이 9라는 것을 통해
