...
/*
시나리오] 여러개의 숫자를 입력받은후 최대값을 구하는 메소드를 정의하시오.
...
public class E05MethodType04_2 {
	...
	public static void main(String[] args) {
		...
		// 출력문 내부에서 메서드 호출
		System.out.println("최대값 : " + returnMaxNumber(6));
	}
	/*
	...
	static int returnMaxNumber(int numberCnt) {
		...
		for(int i=1; i<=numberCnt; i++) {
			...
			if(i==1) {
				/*
				입력받은 정수중에서 최대값을 찾아야 하므로, 첫번째 입력값을 비교를 위한 기준값으로 설정한다.
		...
		/*
		즉, 새로운 입력값이 기존값보다 크다면 지속적으로 교체하여 가장 큰 값을 호출한 지점으로 반환한다.
		 */
		return maxVal;
	}
