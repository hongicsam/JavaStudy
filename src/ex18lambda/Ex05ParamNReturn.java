 ...
 */
@FunctionalInterface
interface GugudanRanger {
	public String[][] guguString(int n1, int n2);
}
/*
매개변수도 없고 반환값도 없음 : 
단순히 메뉴만 츨력하는 기능을 가진다.
 */
@FunctionalInterface
interface MenuPrint {
...
public class Ex05ParamNReturn {
	...
	public static void main(String[] args) {
		...
		호출시에는 부모 인터체이스의 추상메서드인 makeString()을 이용하면된다.
		 */
		StringConcat sc = (a,b) -> {
		 ...
		 */
		String[][] returnStr = gugudanRanger.guguString(4, 6);
